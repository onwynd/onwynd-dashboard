...
export function DealsTable() {
  const deals = useAdminStore((state) => state.deals);
  const searchQuery = useAdminStore((state) => state.searchQuery);
  const stageFilter = useAdminStore((state) => state.stageFilter);
  const ownerFilter = useAdminStore((state) => state.ownerFilter);
  const valueFilter = useAdminStore((state) => state.valueFilter);
  const setSearchQuery = useAdminStore((state) => state.setSearchQuery);
  const setStageFilter = useAdminStore((state) => state.setStageFilter);
  const setOwnerFilter = useAdminStore((state) => state.setOwnerFilter);
  const setValueFilter = useAdminStore((state) => state.setValueFilter);
