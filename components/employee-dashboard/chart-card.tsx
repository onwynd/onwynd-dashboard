...
const COMPLETED_COLOR_LIGHT = "#252C2C";
const COMPLETED_COLOR_DARK = "#E8E9ED"; // Gris clair pour dark mode
...
export function ChartCard() {
  const { chartData } = useEmployeeStore();
  ...
  const completedColor = isDark ? COMPLETED_COLOR_DARK : COMPLETED_COLOR_LIGHT;
