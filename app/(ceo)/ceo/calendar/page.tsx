 ...
 * CEO Calendar
 *
 * Board meetings, investor calls, all-hands, executive 1:1s,
 * company milestones, press, partnerships, and strategy sessions.
 *
 * Route: /ceo/calendar
 * Layout: (ceo)/layout.tsx → CEO sidebar + header already provided.
 */
