...
function Content() {
  ...
  useEffect(() => {
    // Read period directly from store (not closure) so we see any update Effect 1 just made.
    // searchParams is intentionally excluded from deps — the URL change it causes must not
    // re-trigger this effect or the two sync effects will oscillate indefinitely.
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Link href="/admin/finance/revenue">View Details</Link>
                </Button>
              </div>
            </div>
          </CardHeader>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button asChild size="sm" variant="secondary">
                  <Link href="/marketing/dashboard">View Details</Link>
                </Button>
              </div>
            </div>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Select value={activityRange} onValueChange={(v: string | null) => { setActivityRange((v ?? "") as any); fetchActivities((v ?? "") as any); }}>
